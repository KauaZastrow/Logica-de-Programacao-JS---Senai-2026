...
//a)
let letras3 = [letras1[0], letras1[2], letras1[5]];
console.log(letras3); //apenas estou verificando
//b)
let letras4 = [letras1[4], letras1[5]];
console.log(letras4); //apenas estou verificando
...
console.log(batata); //apenas estou verificando
