...
//
//  • Nome do(s) aluno(s): Felipe Buttendorf Dama
//
// ============================================================
...
// → Seu código aqui:
let orcamentoText = null
let resp2 = null;
let resp3 = null;
let destino = null;
const nomeViajante = lerTeclado.question(`
====================
Nome do viajante:
`);
const idadeViajante = lerTeclado.questionInt(`
====================
Idade do viajante:`); 
console.log(`
==============
...
let orcamento = lerTeclado.questionInt(
  `Qual o orcamento que voce deseja investir nessa viagem?`
);

switch (orcamento) {
  case 1:
    orcamentoText = "Econômico";
    break;
  case 2:
    orcamentoText = "Moderado";
    break;
  case 3:
    orcamentoText = "Luxo";
    break;
  default:
    console.log(`
        ==================================================
        Número inválido. Por favor, tente mais uma vez.`);
    process.exit();
}
console.log(`
======================================================================
Olá, ${nomeViajante}! Vamos encontrar o destino perfeito para você.`);
const resp1 = lerTeclado.questionInt(`
=================================
...
switch (resp1) {
  ...
  case 3:
    resp2 = lerTeclado.questionInt(`
        ...
        1) Cultura, museus e arquitetura historica
        2) Natureza, trilhas e parques nacionais`);
    if (resp2 !== 1 && resp2 !== 2) {
      console.log(`
            ==================================================
...
// Nome do viajante:
// `);
// ---->É possivel digitar números negativos e não ha limite de idade<----
  //  2) ---->O codigo de nome aceita caracteres vazios<----
  //  3) ---->O codigo tem erros de identacao nos: "if" e "switch"<----
  //  Dica: selecione o codigo todo (Ctrl + A) e depois aperte: Shift + Alt + F. Assim ira formatar todo o seu codigo rapido
