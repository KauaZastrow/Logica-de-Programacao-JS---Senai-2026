...
//     altura: lerTeclado.questionFloat("sua altura (m): ")
// }
...
// console.log(`${pessoa.nome}, seu IMC é ${pessoa.imc} – classificação: ${pessoa.classificacao}.`)
...
if (!conta.senha === lerTeclado.questionInt("digite sua senha: ")){
