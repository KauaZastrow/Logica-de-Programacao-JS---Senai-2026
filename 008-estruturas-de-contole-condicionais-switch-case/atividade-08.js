...
// console.log(`O tipo do veiculo é: ${tipoVeiculo} e sua categoria é: ${categoria}`);
...
// let a = lerTeclado.questionInt(`
// Escolha um numero que correspondente a sua hora atual e digite-o: 
// 1 - Manhã | 2 - Tarde | 3 - Noite
// : `);
...
// let estacaoFavorita = lerTeclado.question("digite sua estacao favorita(sem acentos ou letras maiusculas): ");
// switch (estacaoFavorita) {
//     case "verao":
...
// let numero = lerTeclado.questionInt("escolha um numero de 1 a 7: ")
// switch (numero) {
//     case 1:
//     case 2:
//     case 3:
...
//     categoria: lerTeclado.questionInt(`
//     | 1 – Eletrônico | 2 – Vestuário | 3 – Alimento | 4 – Livro
//     digite número de 1 a 4: `),
